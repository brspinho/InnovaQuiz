...
npm run install-all
```
*Este comando instalará as dependências da raiz e do servidor automaticamente.*
...
Se você for realizar um evento e precisar que os jogadores acessem de fora da sua rede:
```bash
npm run tunnel
```
*Isso gerará o link fixo do Ngrok que configuramos para você.*
...
---
*Desenvolvido para o Innovation Hub - UFS*
